...
# Input pengguna
luas_bangunan = st.number_input("Luas Bangunan", min_value=10, max_value=1000, step=1)
luas_tanah = st.number_input("Luas Tanah", min_value=10, max_value=20000, step=1)
