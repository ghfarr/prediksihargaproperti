...
# Input pengguna tanpa batas maksimal
...
# Tampilkan nama asli Neighborhood (huruf)
neighborhood_labels = label_encoders['Neighborhood'].classes_.tolist()
