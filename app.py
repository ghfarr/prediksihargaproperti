...
# Pilihan lokasi (Neighborhood) dengan label (huruf)
...
if st.button("Prediksi Harga"):
    try:
        ...
        # Tampilkan hasil dalam satuan juta (jika datanya memang begitu)
        harga_jutaan = harga_prediksi / 1_000_000
        st.success(f"💰 Estimasi Harga Properti: Rp {harga_jutaan:,.2f} juta")
